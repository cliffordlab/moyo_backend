...
func (v *vaultClient) GetCryptoKey(path string) (string, error) {
	...
	//var key string
	//if data, ok := dataMap.(map[string]interface{}); ok {
	//	key = data["ENCRYPTION_KEY"].(string)
	//}
	//return key, nil
	if err != nil {
		return "", err
...
func (v *vaultClient) GetEmailLambdaAPIKey(path string) (string, error) {
	...
	//var key string
	//if data, ok := dataMap.(map[string]interface{}); ok {
	//	key = data["EMAIL_LAMBDA_API_KEY"].(string)
	//}
	//return key, nil
	if err != nil {
		return "", err
...
func (v *vaultClient) GetDbCreds(path string) (amossCreds, error) {
	...
	//log.Print(dataMap)
	//if data, ok := dataMap.(map[string]interface{}); ok {
	//	creds.DBAddr = data["dbaddr"].(string)
	//	creds.DBUser = data["dbuser"].(string)
	//	creds.DBUserPW = data["dbuserpw"].(string)
	//}
	//return creds, nil
